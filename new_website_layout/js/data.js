...
var basins = [
    ...
    { name: ' Delaware', id: 7 },
    { name: ' Florida_Ochlockonee Bay', id: 8 },
    { name: ' Florida_Pensacola Bay', id: 9 },
    { name: ' Florida_Southeast', id: 10 },
    { name: ' Florida_Southwest', id: 11 },
    { name: ' Great Salt Lake', id: 12 },
    { name: ' Hudson', id: 13 },
    { name: ' Humboldt River Basin', id: 14 },
    { name: ' Maine_bay', id: 15 },
    { name: ' Massachusetts bay', id: 16 },
    { name: ' Missouri River Basin', id: 17 },
    { name: ' Mobile River Basin', id: 18 },
    { name: ' Ohio River Basin', id: 19 },
    { name: ' Rio Grande River Basin', id: 20 },
    { name: ' Sacramento_basin', id: 21 },
    { name: ' San_Joaquin', id: 22 },
    { name: ' Satilla_and_Altamaha_River', id: 23 },
    { name: ' Suwannee River Basin', id: 24 },
    { name: ' Trinity-Neches-Sabine River Basin', id: 25 },
    { name: ' Upper Mississippi River Basin', id: 26 },
    { name: ' Columbia River Basin', id: 27 },
