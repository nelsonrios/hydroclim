...
var basins = [
    ...
    { name: ' newtest_apalachicola', id: 19 },
    { name: ' Ohio River Basin', id: 20 },
    { name: ' Rio Grande River Basin', id: 21 },
    { name: ' Sacramento_basin', id: 22 },
    { name: ' Sacramento-San Joaquin', id: 23 },
    { name: ' San_Joaquin', id: 24 },
    { name: ' Satilla_and_Altamaha_River', id: 25 },
    { name: ' Suwannee River Basin', id: 26 },
    { name: ' Trinity-Neches-Sabine River Basin', id: 27 },
    { name: ' Upper Mississippi River Basin', id: 28 },
    { name: ' Columbia River Basin', id: 29 }
]